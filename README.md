...
&nbsp;
<picture><source media="(prefers-color-scheme: dark)" srcset="https://www.shieldcn.dev/github/contributors/panonim/aiofiles.svg?theme=neutral&amp;size=lg&amp;mode=dark&amp;variant=secondary&amp;font=space-grotesk"><img alt="Contributors" src="https://www.shieldcn.dev/github/contributors/panonim/aiofiles.svg?theme=neutral&amp;size=lg&amp;mode=light&amp;variant=secondary&amp;font=space-grotesk"></picture>
&nbsp;
...
&nbsp;
<a href="https://ko-fi.com/panonim"><picture><source media="(prefers-color-scheme: dark)" srcset="https://shieldcn.dev/badge/Sponsor.svg?variant=secondary&amp;size=lg&amp;theme=neutral&amp;font=space-grotesk&amp;logo=ri%3ABsHeartFill&amp;mode=dark"><img alt="badge" src="https://shieldcn.dev/badge/Sponsor.svg?variant=secondary&amp;size=lg&amp;theme=neutral&amp;font=space-grotesk&amp;logo=ri%3ABsHeartFill&amp;mode=light"></picture></a></p>